...
use crate::{
    bindings, c_types, device, driver, error::from_kernel_result, str::CStr, to_result,
...
impl<T: Driver> driver::DriverOps for Adapter<T> {
    ...
    unsafe fn register(
        ...
        //   - `virtio_device_id` is either a raw pointer with static lifetime,
...
impl<T: Driver> Adapter<T> {
    extern "C" fn probe_callback(vdev: *mut bindings::virtio_device) -> c_types::c_int {
        from_kernel_result! {
...
///
/// ```ignore
/// # use kernel::{virtio, define_of_id_table, module_virtio_driver};
/// #
/// struct MyDriver;
...
/// #   }
/// #   define_of_id_table! {(), [
/// #       (of::DeviceId::Compatible(b"virtio,virtio-net"), None),
/// #   ]}
/// }
///
